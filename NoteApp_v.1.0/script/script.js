...
function tampilkanCatatan(catatan) {
  ...
  catatan.forEach((cat) => {
    const itemCatatan = document.createElement("div");
    itemCatatan.classList.add("item-catatan");
...
function tambahCatatan() {
  ...
  const judulInput = document.getElementById("judul-catatan");
  const isiInput = document.getElementById("isi-catatan");
